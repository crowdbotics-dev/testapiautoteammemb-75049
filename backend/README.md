...
## Project Structure
    ...
    ├── testapiautoteammemb_75049  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_75049`
...
2. Clone this repo and `cd testapiautoteammemb_75049`
